...
public class VarGameStart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_var_game_start);
        ...
        mTrueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mAnswer) {
                    mScore++;
                    updateScore(mScore);
                    Toast.makeText(VarGameStart.this, "Acertou!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(VarGameStart.this, "Errou!", Toast.LENGTH_SHORT).show();
                }

                if (mQuestionNumber >= mQuestionList.size()) {
                    Intent i = new Intent(VarGameStart.this, VarGameEnd.class);
                    Bundle bundle = new Bundle();
                    bundle.putInt("pontos", mScore);
                    i.putExtras(bundle);
                    VarGameStart.this.finish();
                    startActivity(i);
                } else {
                    updateQuestion();
                }
    ...
    private void initializeQuestions() {
        mQuestionList.clear();
        for (int i = 0; i < QuizBook2.questions.length; i++) {
            mQuestionList.add(new Question(QuizBook2.images[i], QuizBook2.questions[i], QuizBook2.answers[i]));
        }
    }
